// =============================================
// NAVBAR + BUSCADOR RESPONSIVE FIXED
// =============================================
...
function search(query) {
    ...
    return database
        .map((item) => {
            ...
            const alternos =
                normalizeText(item["titulo alternos"]);

            const sinopsis =
                normalizeText(item.sinopsis);
...
function injectSearchCSS() {
    ...
    if (
        document.getElementById("lz-search-css")
    ) return;
...
function renderModalResults(query) {
    ...
    const grid =
        document.getElementById("lz-resultsGrid");
