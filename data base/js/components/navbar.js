// =============================================
// NAVBAR + BUSCADOR UNIFICADO - LZPLAY (v2.0)
// =============================================
...
function renderNavbar(containerId = "main-header") {
    ...
    // === INICIALIZAR BUSCADOR INMEDIATAMENTE ===
    initSearch();
}
...
async function initSearch() {
    ...
    // Adjuntar listeners al input del navbar
    ...
    console.log("%c✅ Navbar + Buscador unificado cargado correctamente", "color:#22c55e; font-weight:bold");
}

// ==================== FUNCIÓN PRINCIPAL ====================
function initNavbar(containerId = "main-header") {
    renderNavbar(containerId);
    console.log("✅ Navbar inicializado (versión unificada)");
}
